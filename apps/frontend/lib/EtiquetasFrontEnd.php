...
class EtiquetasFrontEnd {
    ...
    public static $KM_INICIAL_AUTO = 'Km Inicial Auto';
    public static $KM_FINAL_AUTO = 'Km Final Auto';
    ...
    public static $KM_INICIAL_RELOJ = 'Km Inicial Reloj';
    public static $KM_FINAL_RELOJ = 'Km Final Reloj';
    public static $FICHAS_INICIALES = 'Fichas Iniciales';
    public static $FICHAS_FINALES = 'Fichas Finales';
    public static $FICHAS_DIURNAS = 'Fichas Diurnas';
    public static $FICHAS_NOCTURNAS = 'Fichas Nocturnas';

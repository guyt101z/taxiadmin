<table class="table">
    ...
    <tbody>
        <?php foreach ($chofer->getAccidentes() as $accidente): ?>
            <tr>
                <td><?php echo $accidente->getFecha() ?></td>
                <td><?php echo $accidente->getMovil() ?></td>
                ...
                <td colspan="2">
                    ...
                    <input title="Editar" src="/images/app/icons/edit.png" type="image" onclick="showEditDialog('Editar Accidente', '<?php echo url_for('accidente/edit?id=' . $accidente->getId() . '&idChofer=' . $chofer->getId()) ?>', '400', fValidateAccidente, fOkAccidente); return false;" />

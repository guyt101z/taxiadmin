...
class Movil
{
     ...
     * Add gastos
     *
     * @param \TaxiAdmin\GastoBundle\Entity\GastoMovil $gastos
     * @return Movil
     */
    public function addGasto(\TaxiAdmin\GastoBundle\Entity\GastoMovil $gastos)
    {
        $this->gastos[] = $gastos;
     ...
     * @param \TaxiAdmin\GastoBundle\Entity\GastoMovil $gastos
     */
    public function removeGasto(\TaxiAdmin\GastoBundle\Entity\GastoMovil $gastos)
    {

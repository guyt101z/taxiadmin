...
/**
 * This class defines the structure of the 'gastoEmpresa' table.
 *
 *
 ...
 */
class GastoempresaTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.GastoempresaTableMap';
	...
	{
	  // attributes
		$this->setName('gastoEmpresa');
		$this->setPhpName('Gastoempresa');
		$this->setClassname('Gastoempresa');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
		$this->addForeignKey('IDEMPRESA', 'Idempresa', 'INTEGER', 'empresa', 'ID', true, null, null);
		$this->addColumn('FECHA', 'Fecha', 'DATE', true, null, null);
		$this->addColumn('COSTO', 'Costo', 'DECIMAL', true, 17, null);
		$this->addColumn('DETALLE', 'Detalle', 'VARCHAR', true, 300, null);

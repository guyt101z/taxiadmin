...
/**
 * This class defines the structure of the 'gastoMovil' table.
 *
 *
 ...
 */
class GastomovilTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.GastomovilTableMap';
	...
	{
	  // attributes
		$this->setName('gastoMovil');
		$this->setPhpName('Gastomovil');
		$this->setClassname('Gastomovil');

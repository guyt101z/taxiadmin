...
/**
 * This class defines the structure of the 'chofer_empresa' table.
 *
 *
 ...
 */
class ChoferEmpresaTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ChoferEmpresaTableMap';
	...
	{
	  // attributes
		$this->setName('chofer_empresa');
		$this->setPhpName('ChoferEmpresa');
		$this->setClassname('ChoferEmpresa');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(false);
		// columns
		$this->addForeignPrimaryKey('IDCHOFER', 'Idchofer', 'INTEGER' , 'chofer', 'ID', true, null, null);

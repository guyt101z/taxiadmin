...
class RecaudacionTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('KM', 'Km', 'DECIMAL', true, 17, null);
		$this->addColumn('RECAUDACION', 'Recaudacion', 'DECIMAL', true, 17, null);
		$this->addColumn('TOTALGASTOS', 'Totalgastos', 'DECIMAL', true, 17, null);
		...
		$this->addColumn('APORTELEYES', 'Aporteleyes', 'DECIMAL', true, 17, null);

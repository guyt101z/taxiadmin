...
abstract class BaseConfiguracionPeer {
	...
	const IDUSUARIO = 'configuracion.IDUSUARIO';

	/** the column name for the FICHANOCTURNA field */
	const FICHANOCTURNA = 'configuracion.FICHANOCTURNA';

	/** the column name for the FICHADIURNA field */
	const FICHADIURNA = 'configuracion.FICHADIURNA';

	/** the column name for the BANDERADIURNA field */
	const BANDERADIURNA = 'configuracion.BANDERADIURNA';

	/** the column name for the BANDERANOCTURNA field */
	const BANDERANOCTURNA = 'configuracion.BANDERANOCTURNA';

	/** the column name for the AVISOVENCIMIENTO field */
	const AVISOVENCIMIENTO = 'configuracion.AVISOVENCIMIENTO';

	/** the column name for the ID field */
	const ID = 'configuracion.ID';

	/**
	 * An identiy map to hold any loaded instances of Configuracion objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idusuario', 'Fichanocturna', 'Fichadiurna', 'Banderadiurna', 'Banderanocturna', 'Avisovencimiento', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idusuario', 'fichanocturna', 'fichadiurna', 'banderadiurna', 'banderanocturna', 'avisovencimiento', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::IDUSUARIO, self::FICHANOCTURNA, self::FICHADIURNA, self::BANDERADIURNA, self::BANDERANOCTURNA, self::AVISOVENCIMIENTO, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('idUsuario', 'fichaNocturna', 'fichaDiurna', 'banderaDiurna', 'banderaNocturna', 'avisoVencimiento', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idusuario' => 0, 'Fichanocturna' => 1, 'Fichadiurna' => 2, 'Banderadiurna' => 3, 'Banderanocturna' => 4, 'Avisovencimiento' => 5, 'Id' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idusuario' => 0, 'fichanocturna' => 1, 'fichadiurna' => 2, 'banderadiurna' => 3, 'banderanocturna' => 4, 'avisovencimiento' => 5, 'id' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::IDUSUARIO => 0, self::FICHANOCTURNA => 1, self::FICHADIURNA => 2, self::BANDERADIURNA => 3, self::BANDERANOCTURNA => 4, self::AVISOVENCIMIENTO => 5, self::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('idUsuario' => 0, 'fichaNocturna' => 1, 'fichaDiurna' => 2, 'banderaDiurna' => 3, 'banderaNocturna' => 4, 'avisoVencimiento' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		$criteria->addSelectColumn(ConfiguracionPeer::IDUSUARIO);
		$criteria->addSelectColumn(ConfiguracionPeer::FICHANOCTURNA);
		$criteria->addSelectColumn(ConfiguracionPeer::FICHADIURNA);
		$criteria->addSelectColumn(ConfiguracionPeer::BANDERADIURNA);
		$criteria->addSelectColumn(ConfiguracionPeer::BANDERANOCTURNA);
		$criteria->addSelectColumn(ConfiguracionPeer::AVISOVENCIMIENTO);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseConfiguracionPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Configuracion $value A Configuracion object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Configuracion $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ConfiguracionPeer::getOMClass(false);
	...
	public static function doCountJoinUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ConfiguracionPeer::IDUSUARIO, UsuarioPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Configuracion objects pre-filled with their Usuario objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ConfiguracionPeer::addSelectColumns($criteria);
		$startcol = (ConfiguracionPeer::NUM_COLUMNS - ConfiguracionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Configuracion) to $obj2 (Usuario)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ConfiguracionPeer::addSelectColumns($criteria);
		$startcol2 = (ConfiguracionPeer::NUM_COLUMNS - ConfiguracionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Configuracion) to the collection in $obj2 (Usuario)
				$obj2->addConfiguracion($obj1);
	...
	{
		return $withPrefix ? ConfiguracionPeer::CLASS_DEFAULT : ConfiguracionPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Configuracion or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConfiguracionPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(ConfiguracionPeer::ID) && $criteria->keyContainsValue(ConfiguracionPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ConfiguracionPeer::ID.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseConfiguracionPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Configuracion or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConfiguracionPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseConfiguracionPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the configuracion table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Configuracion or Criteria object OR a primary key value.
	 *
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseConfiguracionPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }

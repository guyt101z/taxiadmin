...
/**
 * Base class that represents a row from the 'gastoEmpresa' table.
 *
 * 
 *
 ...
 */
abstract class BaseGastoempresa extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseGastoempresa object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Gastoempresa The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = GastoempresaPeer::ID;
		}
	...
	public function setIdempresa($v)
	{
		...
		if ($this->idempresa !== $v) {
			$this->idempresa = $v;
			$this->modifiedColumns[] = GastoempresaPeer::IDEMPRESA;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GastoempresaPeer::FECHA;
			}
	...
	public function setCosto($v)
	{
		...
		if ($this->costo !== $v) {
			$this->costo = $v;
			$this->modifiedColumns[] = GastoempresaPeer::COSTO;
		}
	...
	public function setDetalle($v)
	{
		...
		if ($this->detalle !== $v) {
			$this->detalle = $v;
			$this->modifiedColumns[] = GastoempresaPeer::DETALLE;
		}
	...
	public function setFechaalta($v)
	{
		...
		if ( $this->fechaalta !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GastoempresaPeer::FECHAALTA;
			}
		} // if either are not null
	...
	public function setFechabaja($v)
	{
		...
		if ( $this->fechabaja !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GastoempresaPeer::FECHABAJA;
			}
		} // if either are not null
	...
	public function setHabilitado($v)
	{
		...
		if ($this->habilitado !== $v || $this->isNew()) {
			$this->habilitado = $v;
			$this->modifiedColumns[] = GastoempresaPeer::HABILITADO;
		}
	...
	public function setUsuario($v)
	{
		...
		if ($this->usuario !== $v) {
			$this->usuario = $v;
			$this->modifiedColumns[] = GastoempresaPeer::USUARIO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = GastoempresaPeer::NUM_COLUMNS - GastoempresaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Gastoempresa object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = GastoempresaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseGastoempresa:delete:pre') as $callable)
			{
			...
			if ($ret) {
				GastoempresaPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseGastoempresa:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseGastoempresa:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseGastoempresa:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				GastoempresaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = GastoempresaPeer::doInsert($this, $con);
					...
					$affectedRows += GastoempresaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = GastoempresaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = GastoempresaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = GastoempresaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GastoempresaPeer::ID)) $criteria->add(GastoempresaPeer::ID, $this->id);
		if ($this->isColumnModified(GastoempresaPeer::IDEMPRESA)) $criteria->add(GastoempresaPeer::IDEMPRESA, $this->idempresa);
		if ($this->isColumnModified(GastoempresaPeer::FECHA)) $criteria->add(GastoempresaPeer::FECHA, $this->fecha);
		if ($this->isColumnModified(GastoempresaPeer::COSTO)) $criteria->add(GastoempresaPeer::COSTO, $this->costo);
		if ($this->isColumnModified(GastoempresaPeer::DETALLE)) $criteria->add(GastoempresaPeer::DETALLE, $this->detalle);
		if ($this->isColumnModified(GastoempresaPeer::FECHAALTA)) $criteria->add(GastoempresaPeer::FECHAALTA, $this->fechaalta);
		if ($this->isColumnModified(GastoempresaPeer::FECHABAJA)) $criteria->add(GastoempresaPeer::FECHABAJA, $this->fechabaja);
		if ($this->isColumnModified(GastoempresaPeer::HABILITADO)) $criteria->add(GastoempresaPeer::HABILITADO, $this->habilitado);
		if ($this->isColumnModified(GastoempresaPeer::USUARIO)) $criteria->add(GastoempresaPeer::USUARIO, $this->usuario);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(GastoempresaPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Gastoempresa (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Gastoempresa Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     GastoempresaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new GastoempresaPeer();
		}
		return self::$peer;
	}
	...
	public function getEmpresa(PropelPDO $con = null)
	{
		if ($this->aEmpresa === null && ($this->idempresa !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aEmpresa->addGastoempresas($this);
			 */
		}
	...
	public function getUsuarioRelatedByUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByUsuario === null && ($this->usuario !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByUsuario->addGastoempresas($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseGastoempresa:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseGastoempresa::%s', $method));
	  }

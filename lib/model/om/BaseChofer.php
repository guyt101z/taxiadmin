...
abstract class BaseChofer extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the porcentajeliquidacion field.
	 * @var        string
	 */
	protected $porcentajeliquidacion;
	...
	/**
	 * Get the [porcentajeliquidacion] column value.
	 * 
	 * @return     string
	 */
	...
	public function setAporteleyes($v)
	{
		...
		if ($this->aporteleyes !== $v) {
			$this->aporteleyes = $v;
			$this->modifiedColumns[] = ChoferPeer::APORTELEYES;
		}
	...
	/**
	 * Set the value of [porcentajeliquidacion] column.
	 * 
	 * @param      string $v new value
	 * @return     Chofer The current object (for fluent API support)
	 */
	public function setPorcentajeliquidacion($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->porcentajeliquidacion !== $v) {
			$this->porcentajeliquidacion = $v;
			$this->modifiedColumns[] = ChoferPeer::PORCENTAJELIQUIDACION;
		}

		return $this;
	} // setPorcentajeliquidacion()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->aporteleyes = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->porcentajeliquidacion = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->vencimientolibretaconducir = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->vencimientocarnesalud = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			...
			return $startcol + 16; // 16 = ChoferPeer::NUM_COLUMNS - ChoferPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 8:
				...
				break;
			case 9:
				return $this->getPorcentajeliquidacion();
				break;
			case 10:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[8] => $this->getAporteleyes(),
			$keys[9] => $this->getPorcentajeliquidacion(),
			$keys[10] => $this->getVencimientolibretaconducir(),
			$keys[11] => $this->getVencimientocarnesalud(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 8:
				...
				break;
			case 9:
				$this->setPorcentajeliquidacion($value);
				break;
			case 10:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setAporteleyes($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setPorcentajeliquidacion($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setVencimientolibretaconducir($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setVencimientocarnesalud($arr[$keys[11]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ChoferPeer::APORTELEYES)) $criteria->add(ChoferPeer::APORTELEYES, $this->aporteleyes);
		if ($this->isColumnModified(ChoferPeer::PORCENTAJELIQUIDACION)) $criteria->add(ChoferPeer::PORCENTAJELIQUIDACION, $this->porcentajeliquidacion);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPorcentajeliquidacion($this->porcentajeliquidacion);

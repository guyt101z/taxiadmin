...
abstract class BaseEvento extends BaseObject  implements Persistent {
	...
	public function setIdusuario($v)
	{
		...
		if ($this->idusuario !== $v) {
			$this->idusuario = $v;
			$this->modifiedColumns[] = EventoPeer::IDUSUARIO;
		}
	...
	public function setEvento($v)
	{
		...
		if ($this->evento !== $v) {
			$this->evento = $v;
			$this->modifiedColumns[] = EventoPeer::EVENTO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->evento = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = EventoPeer::NUM_COLUMNS - EventoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setEvento($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventoPeer::IDUSUARIO)) $criteria->add(EventoPeer::IDUSUARIO, $this->idusuario);
		if ($this->isColumnModified(EventoPeer::EVENTO)) $criteria->add(EventoPeer::EVENTO, $this->evento);
